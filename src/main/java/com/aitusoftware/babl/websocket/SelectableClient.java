 ...
 */
public final class SelectableClient
{
    ...
    public SelectableClient(final ClientEventHandler clientEventHandler)
    {
        this.clientEventHandler = clientEventHandler;
        final BufferPool bufferPool = new BufferPool();
        final SessionContainerStatistics serverStatistics = new NoOpSessionContainerStatistics();
        ...
        final SessionStatistics sessionStatistics = new NoOpSessionStatistics();
    ...
    public void sendData()
    {
        ...
        try
        {
            while ((sendResult = frameEncoder.doSendWork(channel)) != 0)
            {
                if (sendResult == SendResult.NOT_CONNECTED)
                {
